...
public class ArchetypeBacking {
	...
	public String getSelectedBuild() {
		...
		if ("maven".equals(favoriteBuild)) {
			...
			FacesContextHelperUtil.addGlobalErrorMessage("Gradle developers can also use the archetype:generate command because it generates a build.gradle file for you to use, if you like.");
