...
@Component(
	immediate = true, property = {
			"com.liferay.portlet.display-category=category.hidden", "com.liferay.portlet.instanceable=true",
			...
			"javax.portlet.name=primefaces_users_applicant", "javax.portlet.display-name=primefaces-users-portlet",
